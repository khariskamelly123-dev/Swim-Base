    ...
    <div class="container">
        ...
        <div class="login-box">
            ...
            <form action="{{ route('club.register.process') }}" method="POST">
                ...
                <div class="form-row">
                    <div>
                        ...
                        <div class="input-icon">
                            <input type="tel" id="kontak" name="kontak" placeholder="Nomor telepon" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="input-icon">
                            <input type="email" id="email_resmi" name="email_resmi" placeholder="superadmin@gmail.com"
                                required>
                        </div>
                    </div>
                </div>
            ...
            <div class="signup-text">
                Sudah punya akun? <a href="{{ route('superadmin_login') }}">Login di sini</a>
            </div>
